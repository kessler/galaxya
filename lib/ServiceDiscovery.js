...
ServiceDiscovery.prototype._proxy = function(emitterMethod, event, version, callback) {
	...
	if (event === 'available') {
		...
		galaxya[emitterMethod](this._name, asyncEvent(callback))
	}
}

// really dont like this
function asyncEvent(callback) {
	return function asyncEventHandler(service) {
		setImmediate(function immediateHandler() {
			callback(service)
		})
	}
}
